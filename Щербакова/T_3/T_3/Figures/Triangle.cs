...

{
    ...
    public class Triangle : AbstractFigure
    {
        ...
        {
            graphics.DrawLine(new Pen(Color.Fuchsia), point_A, point_B);
            graphics.DrawLine(new Pen(Color.Fuchsia), point_C, point_A);
            graphics.DrawLine(new Pen(Color.Fuchsia), point_C, point_B);
